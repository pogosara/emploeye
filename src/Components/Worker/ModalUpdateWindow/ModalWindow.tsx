...
export const ModalUpdateWindow = (props: any) => {

    const [fullName, setFullName] = useState<string>(props.worker && props.worker.fullName )
    const [gender, setGender] = useState<string>(props.worker && props.worker.gender)
    const [contacts, setContacts] = useState<string>(props.worker && props.worker.contacts )
    const [salary, setSalary] = useState<string>(props.worker && props.worker.salary)
    const [position, setPosition] = useState<string>(props.worker && props.worker.position)
